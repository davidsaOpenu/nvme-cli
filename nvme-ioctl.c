...
int nvme_obj_io(int fd, __u8 opcode, __u64 offset, __u64 data_size, void **data, __u8 *obj_id)
{
	...
	strncpy((char*)(io.obj_id), (char*)obj_id, NVME_OBJ_ID_MAXLEN);
	return ioctl(fd, NVME_IOCTL_SUBMIT_OBJ_IO, &io);
}
