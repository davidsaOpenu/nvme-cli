...
{
	const char *desc = "Copy from object of given id to data buffer"\
				" (default buffer is stdout) on the given device.";
	return submit_object_io(nvme_cmd_obj_read, "read", desc, argc, argv);
}
